...
<template>
  <body class=" flex flex-col items-center text-neo-very-dark-blue font-poppins">
    ...
    <main class=" w-full max-w-[425px] DT:max-w-[1920px] bg-other-two">
      <section
        class=" relative top-[-80px] flex flex-col DT:flex-row items-center gap-4 DT:gap-6 DT:h-[168px] mx-6 DT:mx-[165px] -mb-12 p-6 DT:px-16 bg-neo-dark-violet rounded-[10px]"
      ...
      <section class=" flex flex-col gap-6 DT:gap-4 w-full mb-20 DT:mb-[120px] px-6 DT:px-[165px]">
      ...
      <section class=" DT:flex DT:flex-col DT:gap-3 w-full mb-20 DT:mb-[120px] px-6 DT:px-[165px]">
